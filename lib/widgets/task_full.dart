...
import 'package:repeat_me/views/edit_task.dart';
    ...
    return Material(
      ...
      child: Container(
        ...
        child: InkWell(
          ...
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => EditTask(_remainder), maintainState: false));
          },  
          child: Container(
